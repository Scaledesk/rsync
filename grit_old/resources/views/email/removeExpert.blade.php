                        ...
                        <table style="border-spacing: 0;border-collapse: collapse;vertical-align: top;background-color: #D9D9D9" cellpadding="0" cellspacing="0" align="center" width="100%" border="0">
                                <tbody><tr style="vertical-align: top">
                                 ...
                                 <tr>
                                        <td>
                                       <br>         <!--[if (gte mso 9)|(IE)]>
                                Dear {{$name}}, <br><br>We are Sorry to inform you that Your Account as Expert in GritWings is removed for the following <br><br> Reason:
                                {{$reason}}
                                <br>
                                You can try again later in future with fresh application from JOIN AS EXPERT page of our website or if you have any queries, kindly contact us
                                Regards, GritWings, www.gritwings.com
